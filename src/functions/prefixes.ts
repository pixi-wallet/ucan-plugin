...
/** https://github.com/multiformats/multicodec/blob/e9ecf587558964715054a0afcc01f7ace220952c/table.csv#L90 */
export const SECP256K1_PUB_DID_PREFIX = new Uint8Array([ 0xe7, 0x01 ])
